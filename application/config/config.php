...
//$config['base_url'] = "http://".$_SERVER['HTTP_HOST']."/codeIgniter_project/development/urllink";
$config['base_url'] = 'http://'.$_SERVER['SERVER_NAME'].SITE_URL;
//$config['base_url'] = 'http://'.$_SERVER['SERVER_NAME'].'/'.'domain name'.'/';
...
|
*/
$config['encryption_key'] = '+N7vk4OAjNO7eiYaahkXRV94xPLRbhvfA';
